...
const ControlsStatusChart = dynamic(
  () => import("./components/analytics-charts").then((m) => m.ControlsStatusChart),
  { loading: () => <ChartSkeleton />, ssr: false },
);

const FrameworkPerformanceChart = dynamic(
  () => import("./components/analytics-charts").then((m) => m.FrameworkPerformanceChart),
  { loading: () => <ChartSkeleton />, ssr: false },
);

const ComplianceTrendChart = dynamic(
  () => import("./components/analytics-charts").then((m) => m.ComplianceTrendChart),
  { loading: () => <ChartSkeleton />, ssr: false },
);

const TopAreasChart = dynamic(
  () => import("./components/analytics-charts").then((m) => m.TopAreasChart),
  { loading: () => <ChartSkeleton />, ssr: false },
);
...
// CustomTooltip removed (moved to analytics-charts.tsx)
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
          ...
          <Card className="xl:col-span-2">
            ...
            {frameworkBarData.length === 0 ? (
              ...
              <FrameworkPerformanceChart frameworkBarData={frameworkBarData} />
            )}
          </Card>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
          ...
          <Card className="xl:col-span-2 p-5">
            ...
            categoryData.every(
              ...
              <TopAreasChart categoryData={categoryData} />
            )}
            {filters.category && (
