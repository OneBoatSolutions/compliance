...
const ComplianceDonut = dynamic(() => import("@/components/charts/compliance-donut"), {
  ssr: false,
  loading: () => <Skeleton className="h-[150px] w-[180px] rounded-full mx-auto" />,
});

const FrameworkBar = dynamic(() => import("@/components/charts/framework-bar"), {
  ssr: false,
  loading: () => <Skeleton className="h-[300px] w-full rounded-xl" />,
});

const TrendLine = dynamic(() => import("@/components/charts/trend-line"), {
  ssr: false,
  loading: () => <Skeleton className="h-[250px] w-full rounded-xl" />,
});

const CategoryBar = dynamic(() => import("@/components/charts/category-bar"), {
  ssr: false,
              ...
              <>
                <div className="flex justify-center">
                  <ComplianceDonut
                    ...
                    onCellClick={(name: string) => setFilters({ impact: "", category: name })}
                  />
                </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
          ...
          <Card className="xl:col-span-2">
            ...
            {frameworkBarData.length === 0 ? (
              ...
              <FrameworkBar data={frameworkBarData} />
            )}
          </Card>
